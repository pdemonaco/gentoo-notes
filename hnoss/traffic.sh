...
tc=/sbin/tc
ext=enp6s0              # Change for your device!
ext_ingress=ifb0	    # Use a unique ifb per rate limiter!
			            # Set these as per your provider's settings, at 90% to start with
ext_up=9828kbit         # Max theoretical: for this example, up is 1024kbit
ext_down=48000kbit	    # Max theoretical: for this example, down is 8192kbit
...
$tc qdisc add dev $ext parent 1:11 fq_codel quantum $quantum
